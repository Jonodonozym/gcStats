...
public abstract class HookedStatType implements StatType{
	...
	@Override
	public void addPlayer(Player player, double value) { lastValues.put(player, -1.0); }

	@Override
	public double removePlayer(Player player) { lastValues.remove(player); return get(player); }
