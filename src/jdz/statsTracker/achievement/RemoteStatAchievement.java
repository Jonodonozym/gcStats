...
class RemoteStatAchievement extends RemoteAchievement {
	...
	public RemoteStatAchievement(String server, String name, int points, Material m, short iconDamage, String description, String rewardText, 
			boolean hidden, String statType, double requirement) {
